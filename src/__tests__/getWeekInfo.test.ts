...
it('should return current week info when has no arguments passed', () => {
...
it('should return correct week info when passed positive week offset', () => {
  const expectedResult = [
    {
      year: 2001,
      month: 3,
...
it('should return correct week info when passed negative week offset', () => {
  const expectedResult = [
    {
      year: 2001,
      month: 2,
